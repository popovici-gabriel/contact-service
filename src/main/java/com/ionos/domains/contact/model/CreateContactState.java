...
public enum CreateContactState {
	...
	CONTACT_REGISTRY_INITIATED, CONTACT_REGISTRY_SUCCESS, CONTACT_REGISTRY_ERROR,

	CONTACT_PERSISTENCE_INITIATED, CONTACT_PERSISTENCE_SUCCESS, CONTACT_PERSISTENCE_ERROR,
